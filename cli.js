...
const PLATFORM_HELP = {
  ...
  ios: [
    ...
    '  1. Plug iPhone via USB-C/Lightning',
    '  2. Unlock phone + tap "Trust" if prompted',
    '  3. agent-control use ios              # set sticky context',
    '  4. agent-control snapshot --real      # UI element tree',
    '  5. agent-control screenshot /tmp/x.png --real',
    '',
    'Quick start (simulator):',
    '  1. open -a Simulator                  # boot a device',
    '  2. agent-control snapshot --sim',
    '',
    'Commands:',
    ...
    '',
    'Flags:',
    '  --real                    Force real device (USB)',
    '  --sim                     Force simulator',
    '  (default: auto-detect, simulator preferred)',
    '',
